...
# método de pagamento
met = ['Pix','Crédito','Débito','Dinheiro Físico']
porc = []
for m in met:
    porc.append(vendas1['Método de Pagamento'].value_counts()[m])
pormet = px.pie(names=met, values=porc, color_discrete_sequence=['cyan','darkcyan','blue','lightcyan'], title='Compras X Método de Pagamento', hole=0.3)
...
app.layout = html.Div(children=[
    ...
    dcc.Graph(id = 'G15',figure=pormet),
